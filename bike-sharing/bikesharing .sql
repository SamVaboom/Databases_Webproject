...
-- Dumping data for table bikeshare.persona: ~11 rows (approximately)
INSERT INTO `persona` (`persona_id`, `username`, `firstname`, `lastname`, `email`, `phonenum`, `password`, `adress`, `city`, `zipcode`, `subscription_id`, `payment_method`, `account_created`) VALUES
	...
	(2, 'michiii', 'Michael', 'Bucher', 'michael.bucher@mail.ch', 785559911, 'mbucher21', 'Bahnhofstrasse 5', 'Biel', 2501, 5, 'twint', '2023-01-22'),
	...
	(18, 'schoggi021', 'Samira', 'Wurm', 'sam.wfu@mail.com', 774460909, 'schoggi1', 'Richterstrasse 15', 'Biel', 2502, 2, 'twint', '2025-12-02');
...
-- Dumping data for table bikeshare.ride: ~25 rows (approximately)
INSERT INTO `ride` (`ride_id`, `bike_id`, `persona_id`, `start_time`, `end_time`, `ride_feedback`, `customer_comment`) VALUES
	...
	(21, 1, 1, '2025-12-02 09:42:12', '2025-12-02 09:44:25', 2, 'Bla bla bremse am arsch'),
	(22, 3, 1, '2025-12-02 09:49:15', '2025-12-02 09:49:30', 1, 'Chain sucks'),
	(23, 1, 1, '2025-12-02 13:04:04', '2025-12-02 13:04:11', 3, ''),
	(24, 8, 1, '2025-12-02 13:09:00', '2025-12-02 13:09:08', 1, 'Michi'),
	(25, 1, 2, '2025-12-02 14:25:22', '2025-12-02 14:25:30', 2, 'Hey!!!'),
	(26, 4, 2, '2025-12-02 14:32:55', '2025-12-02 14:33:02', 3, ''),
	(27, 4, 2, '2025-12-02 14:34:33', '2025-12-02 14:34:37', 5, ''),
	(28, 6, 2, '2025-12-02 14:35:06', '2025-12-02 14:35:10', 5, '');
...
INSERT INTO `station` (`station_id`, `station_street`, `capacity`, `latitude`, `longitude`) VALUES
	(1, 'Bahnhof Biel', 25, 47.1332, 7.2428),
	(2, 'Nidaugasse', 20, 47.1388, 7.2463),
	(3, 'Kongresshaus', 18, 47.1352, 7.2481),
	(4, 'Tissot Arena', 30, 47.1563, 7.2812),
	(5, 'Strandboden', 15, 47.1347, 7.2302);
